...
INFOBOX_ALIASES = {
    ...
    "affiliation": ["affiliation", "allegiance", "team", "organization", "group", "alignment", "faction", "factions", "side", "clan", "guild", "party", "crew", "association", "member of", "membership"],
    ...
    "ethnicity": ["species", "kind", "creature type", "being", "ethnicity", "ethnic group",
                  ...
                  "citizenship", "country of origin", "language", "native language",
                  "spoken language", "homeland", "home country", "origin country"],
    "height": ["height"],
    "weight": ["weight"],
    "eyes": ["eye color", "eyes"],
